...
5. If you spot any error, click on that node. In poped up Activity Usage Details window you can find call details: Interaction ID, Start and End time, Duretion and cross-launch link to Debugger.
