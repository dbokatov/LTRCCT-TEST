...
4. By Clicking on each Activity Name you will see it's details. Example: Entry point ID, Flow Label, DNIS, selected Business Hours, also TTS value and what events were triggered.
